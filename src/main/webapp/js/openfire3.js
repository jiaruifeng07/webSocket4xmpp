...
function handleIqOpen(){
    var message = "<iq from='"+currentUserId+"@"+serverIP+"'  id='"+iqSiId+"' to='test1@"+serverIP+"/Spark' type='result'/>";
    console.log("send>>>>"+message)
    webSocket.send(message);
}
// function handleSi() {
//     var message = "<iq type='result' to='test1@server3/Spark' from='"+currentUserId+"@"+serverIP+"'  id='"+iqSiId+"'><si xmlns='http://jabber.org/protocol/si'><feature xmlns='http://jabber.org/protocol/feature-neg'><x xmlns='jabber:x:data' type='submit'><field var='stream-method'><value>http://jabber.org/protocol/bytestreams</value><value>http://jabber.org/protocol/ibb</value></field></x></feature></si></iq>";
//     console.log("send>>>>"+message)
//     webSocket.send(message);
// }
//可以用于传小图片
function handleSi() {
    var message = "<iq type='result' to='test1@"+serverIP+"/Spark' from='"+currentUserId+"@"+serverIP+"'  id='"+iqSiId+"'><si xmlns='http://jabber.org/protocol/si'><feature xmlns='http://jabber.org/protocol/feature-neg'><x xmlns='jabber:x:data' type='submit'><field var='stream-method'><value>http://jabber.org/protocol/bytestreams</value><value>http://jabber.org/protocol/ibb</value></field></x></feature></si></iq>";
    console.log("send>>>>"+message)
    webSocket.send(message);
}
// function handleSi() {
//     debugger
//     //发送建立流请求
//     var message = "<iq type='result' to='test1@server3/Spark' id='"+id+"'><si xmlns='http://jabber.org/protocol/si'><feature xmlns='http://jabber.org/protocol/feature-neg'><x xmlns='jabber:x:data' type='submit'><field var='stream-method'><value>http://jabber.org/protocol/bytestreams</value></field></x></feature></si></iq>";
//     console.log("send>>>>"+message)
//     webSocket.send(message);
// }
